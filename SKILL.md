...
description: Maintain bounded state from the first turn of project tasks and for Projectless or other non-project work that is long-running, resumable, or develops recovery, handoff, compaction, or parallel-state needs; skip ordinary one-shot non-project chats.
---
